...
})({"xjTvb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c5526ae4f50b2421";
"use strict";
...
},{}],"hwKWw":[function(require,module,exports) {
var _app = require("firebase/app");
var _auth = require("firebase/auth");
const firebaseConfig = {
    apiKey: "AIzaSyC50W5YbJ2S23CbsH0NW_tFb2iPfCvOupY",
    authDomain: "babalsaray-bcbc2.firebaseapp.com",
    projectId: "babalsaray-bcbc2",
    storageBucket: "babalsaray-bcbc2.appspot.com",
    messagingSenderId: "159373268161",
    appId: "1:159373268161:web:4704e87149e51b24fc7040"
};
const app = (0, _app.initializeApp)(firebaseConfig);
const auth = (0, _auth.getAuth)();
var phoneConfirmationResult;
auth.onAuthStateChanged(async function(user) {
    // console.log(user.phoneNumber);
    if (user !== null) {
        console.log("USER IS LOGGED IN");
        document.querySelector(".user-exist").style.visibility = "visible";
        document.getElementById("send-no-button").disabled = true;
        document.querySelector(".select-box").disabled = true;
        document.getElementById("phone").disabled = true;
        document.getElementById("phone").value = user.phoneNumber.substring(4);
    //Open client page
    //window.location.href = "client.html?phone=" + user.phoneNumber;
    } else {
        console.log("USER NOT LOGGED IN", "API URL");
        document.querySelector(".user-exist").style.visibility = "hidden";
        viewRecaptch();
    }
});
function viewRecaptch() {
    window.recaptchaVerifier = new (0, _auth.RecaptchaVerifier)("recaptcha-container", {
        size: "normal",
        callback: (response)=>{
            document.getElementById("send-no-button").disabled = false;
...
window.signIn = ()=>{
    auth.onAuthStateChanged(async function(user) {
        // console.log(user.phoneNumber);
        if (user != null && user.phoneNumber == "+" + document.getElementById("country-code").value + document.getElementById("phone").value) {
            //console.log("User FOUND", user);
            console.log("USER IS LOGGED IN");
            //Open client page
            window.location.href = "./client.html?phone=" + document.getElementById("country-code").value + document.getElementById("phone").value;
        } else {
            // No user is signed in.
            //checkIfUserExist(params.phone);
            console.log("USER NOT LOGGED IN, Show page");
            submitPhoneNo();
        }
    });
};
...
function submitPhoneNo() {
    var phoneNumber = "+" + document.getElementById("country-code").value + document.getElementById("phone").value;
    var appVerifier = window.recaptchaVerifier;
    //auth.signInWithPhoneNumber();
    (0, _auth.signInWithPhoneNumber)(auth, phoneNumber, appVerifier).then((confirmationResult)=>{
        // SMS sent. Prompt user to type the code from the message, then sign the
        // user in with confirmationResult.confirm(code).
        document.getElementById("verify-button").disabled = false;
        document.querySelector(".code-verify").style.visibility = "visible";
        console.log("Code has been sent", confirmationResult);
...
window.verify = ()=>{
    ...
    var code = document.getElementById("code").value;
    phoneConfirmationResult.confirm(code).then(function(result) {
        window.location.href = "client.html?phone=" + document.getElementById("country-code").value + document.getElementById("phone").value;
    }).catch(function(error) {
        console.log(error);
    });
};
window.copyCountryCodeValue = ()=>{
    document.getElementById("country-code").value = document.getElementById("select-where").value;
};

},{"firebase/app":"aM3Fo","firebase/auth":"79vzg"}],"aM3Fo":[function(require,module,exports) {
...
var global = arguments[3];
var process = require("43bdc399bb8c6f50");
const CONSTANTS = {
    /**
...
},{"43bdc399bb8c6f50":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ActionCodeOperation", ()=>(0, _indexE3F1FbbaJs.A));
parcelHelpers.export(exports, "ActionCodeURL", ()=>(0, _indexE3F1FbbaJs.ad));
parcelHelpers.export(exports, "AuthCredential", ()=>(0, _indexE3F1FbbaJs.H));
parcelHelpers.export(exports, "AuthErrorCodes", ()=>(0, _indexE3F1FbbaJs.D));
parcelHelpers.export(exports, "EmailAuthCredential", ()=>(0, _indexE3F1FbbaJs.I));
parcelHelpers.export(exports, "EmailAuthProvider", ()=>(0, _indexE3F1FbbaJs.M));
parcelHelpers.export(exports, "FacebookAuthProvider", ()=>(0, _indexE3F1FbbaJs.N));
parcelHelpers.export(exports, "FactorId", ()=>(0, _indexE3F1FbbaJs.F));
parcelHelpers.export(exports, "GithubAuthProvider", ()=>(0, _indexE3F1FbbaJs.T));
parcelHelpers.export(exports, "GoogleAuthProvider", ()=>(0, _indexE3F1FbbaJs.Q));
parcelHelpers.export(exports, "OAuthCredential", ()=>(0, _indexE3F1FbbaJs.J));
parcelHelpers.export(exports, "OAuthProvider", ()=>(0, _indexE3F1FbbaJs.U));
parcelHelpers.export(exports, "OperationType", ()=>(0, _indexE3F1FbbaJs.O));
parcelHelpers.export(exports, "PhoneAuthCredential", ()=>(0, _indexE3F1FbbaJs.K));
parcelHelpers.export(exports, "PhoneAuthProvider", ()=>(0, _indexE3F1FbbaJs.P));
parcelHelpers.export(exports, "PhoneMultiFactorGenerator", ()=>(0, _indexE3F1FbbaJs.m));
parcelHelpers.export(exports, "ProviderId", ()=>(0, _indexE3F1FbbaJs.o));
parcelHelpers.export(exports, "RecaptchaVerifier", ()=>(0, _indexE3F1FbbaJs.R));
parcelHelpers.export(exports, "SAMLAuthProvider", ()=>(0, _indexE3F1FbbaJs.V));
parcelHelpers.export(exports, "SignInMethod", ()=>(0, _indexE3F1FbbaJs.S));
parcelHelpers.export(exports, "TwitterAuthProvider", ()=>(0, _indexE3F1FbbaJs.W));
parcelHelpers.export(exports, "applyActionCode", ()=>(0, _indexE3F1FbbaJs.a2));
parcelHelpers.export(exports, "beforeAuthStateChanged", ()=>(0, _indexE3F1FbbaJs.t));
parcelHelpers.export(exports, "browserLocalPersistence", ()=>(0, _indexE3F1FbbaJs.b));
parcelHelpers.export(exports, "browserPopupRedirectResolver", ()=>(0, _indexE3F1FbbaJs.k));
parcelHelpers.export(exports, "browserSessionPersistence", ()=>(0, _indexE3F1FbbaJs.a));
parcelHelpers.export(exports, "checkActionCode", ()=>(0, _indexE3F1FbbaJs.a3));
parcelHelpers.export(exports, "confirmPasswordReset", ()=>(0, _indexE3F1FbbaJs.a1));
parcelHelpers.export(exports, "connectAuthEmulator", ()=>(0, _indexE3F1FbbaJs.G));
parcelHelpers.export(exports, "createUserWithEmailAndPassword", ()=>(0, _indexE3F1FbbaJs.a5));
parcelHelpers.export(exports, "debugErrorMap", ()=>(0, _indexE3F1FbbaJs.B));
parcelHelpers.export(exports, "deleteUser", ()=>(0, _indexE3F1FbbaJs.z));
parcelHelpers.export(exports, "fetchSignInMethodsForEmail", ()=>(0, _indexE3F1FbbaJs.aa));
parcelHelpers.export(exports, "getAdditionalUserInfo", ()=>(0, _indexE3F1FbbaJs.al));
parcelHelpers.export(exports, "getAuth", ()=>(0, _indexE3F1FbbaJs.n));
parcelHelpers.export(exports, "getIdToken", ()=>(0, _indexE3F1FbbaJs.ai));
parcelHelpers.export(exports, "getIdTokenResult", ()=>(0, _indexE3F1FbbaJs.aj));
parcelHelpers.export(exports, "getMultiFactorResolver", ()=>(0, _indexE3F1FbbaJs.an));
parcelHelpers.export(exports, "getRedirectResult", ()=>(0, _indexE3F1FbbaJs.j));
parcelHelpers.export(exports, "inMemoryPersistence", ()=>(0, _indexE3F1FbbaJs.L));
parcelHelpers.export(exports, "indexedDBLocalPersistence", ()=>(0, _indexE3F1FbbaJs.i));
parcelHelpers.export(exports, "initializeAuth", ()=>(0, _indexE3F1FbbaJs.E));
parcelHelpers.export(exports, "isSignInWithEmailLink", ()=>(0, _indexE3F1FbbaJs.a8));
parcelHelpers.export(exports, "linkWithCredential", ()=>(0, _indexE3F1FbbaJs.Z));
parcelHelpers.export(exports, "linkWithPhoneNumber", ()=>(0, _indexE3F1FbbaJs.l));
parcelHelpers.export(exports, "linkWithPopup", ()=>(0, _indexE3F1FbbaJs.d));
parcelHelpers.export(exports, "linkWithRedirect", ()=>(0, _indexE3F1FbbaJs.g));
parcelHelpers.export(exports, "multiFactor", ()=>(0, _indexE3F1FbbaJs.ao));
parcelHelpers.export(exports, "onAuthStateChanged", ()=>(0, _indexE3F1FbbaJs.v));
parcelHelpers.export(exports, "onIdTokenChanged", ()=>(0, _indexE3F1FbbaJs.q));
parcelHelpers.export(exports, "parseActionCodeURL", ()=>(0, _indexE3F1FbbaJs.ae));
parcelHelpers.export(exports, "prodErrorMap", ()=>(0, _indexE3F1FbbaJs.C));
parcelHelpers.export(exports, "reauthenticateWithCredential", ()=>(0, _indexE3F1FbbaJs._));
parcelHelpers.export(exports, "reauthenticateWithPhoneNumber", ()=>(0, _indexE3F1FbbaJs.r));
parcelHelpers.export(exports, "reauthenticateWithPopup", ()=>(0, _indexE3F1FbbaJs.e));
parcelHelpers.export(exports, "reauthenticateWithRedirect", ()=>(0, _indexE3F1FbbaJs.h));
parcelHelpers.export(exports, "reload", ()=>(0, _indexE3F1FbbaJs.am));
parcelHelpers.export(exports, "sendEmailVerification", ()=>(0, _indexE3F1FbbaJs.ab));
parcelHelpers.export(exports, "sendPasswordResetEmail", ()=>(0, _indexE3F1FbbaJs.a0));
parcelHelpers.export(exports, "sendSignInLinkToEmail", ()=>(0, _indexE3F1FbbaJs.a7));
parcelHelpers.export(exports, "setPersistence", ()=>(0, _indexE3F1FbbaJs.p));
parcelHelpers.export(exports, "signInAnonymously", ()=>(0, _indexE3F1FbbaJs.X));
parcelHelpers.export(exports, "signInWithCredential", ()=>(0, _indexE3F1FbbaJs.Y));
parcelHelpers.export(exports, "signInWithCustomToken", ()=>(0, _indexE3F1FbbaJs.$));
parcelHelpers.export(exports, "signInWithEmailAndPassword", ()=>(0, _indexE3F1FbbaJs.a6));
parcelHelpers.export(exports, "signInWithEmailLink", ()=>(0, _indexE3F1FbbaJs.a9));
parcelHelpers.export(exports, "signInWithPhoneNumber", ()=>(0, _indexE3F1FbbaJs.s));
parcelHelpers.export(exports, "signInWithPopup", ()=>(0, _indexE3F1FbbaJs.c));
parcelHelpers.export(exports, "signInWithRedirect", ()=>(0, _indexE3F1FbbaJs.f));
parcelHelpers.export(exports, "signOut", ()=>(0, _indexE3F1FbbaJs.y));
parcelHelpers.export(exports, "unlink", ()=>(0, _indexE3F1FbbaJs.ak));
parcelHelpers.export(exports, "updateCurrentUser", ()=>(0, _indexE3F1FbbaJs.x));
parcelHelpers.export(exports, "updateEmail", ()=>(0, _indexE3F1FbbaJs.ag));
parcelHelpers.export(exports, "updatePassword", ()=>(0, _indexE3F1FbbaJs.ah));
parcelHelpers.export(exports, "updatePhoneNumber", ()=>(0, _indexE3F1FbbaJs.u));
parcelHelpers.export(exports, "updateProfile", ()=>(0, _indexE3F1FbbaJs.af));
parcelHelpers.export(exports, "useDeviceLanguage", ()=>(0, _indexE3F1FbbaJs.w));
parcelHelpers.export(exports, "verifyBeforeUpdateEmail", ()=>(0, _indexE3F1FbbaJs.ac));
parcelHelpers.export(exports, "verifyPasswordResetCode", ()=>(0, _indexE3F1FbbaJs.a4));
var _indexE3F1FbbaJs = require("./index-e3f1fbba.js");
var _util = require("@firebase/util");
var _app = require("@firebase/app");
var _logger = require("@firebase/logger");
...
},{"./index-e3f1fbba.js":"3UC1m","@firebase/util":"ePiK6","@firebase/app":"3AcPV","@firebase/logger":"fZmft","tslib":"lRdW5","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3UC1m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["xjTvb","hwKWw"], "hwKWw", "parcelRequire94c2")

//# sourceMappingURL=login.f50b2421.js.map
